...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 max-w-[480px] mx-auto z-50 shadow-lg">
        ...
        {navItems.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={`text-[10px] ${
                  isActive ? "text-[#E91E63] font-semibold" : "text-gray-400"
                }`}
              >
                {item.label}
              </span>
